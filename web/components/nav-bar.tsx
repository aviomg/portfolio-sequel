...
export default function Navbar({currentpage = "none"}:props){
    const pages = [{title:"Home",link:"/#cont",id:1},{title: "About/CV",link:"/about",id:2},{title:"Notes",link:"/notes",id:4},{title:"Poetry",link:"/entries",id:6},
        {title:"Crochet",link:"/crochet",id:5}]
